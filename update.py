...
def get_manual_curated_deals():
    ...
    return [
        ...
        },
        {
            ...
            "tag": "项目管理",
            "title": "NextStep",
            "desc": "创建和执行可复用 SOP、工作流与检查清单，支持 AI 辅助生成、动态截止日期和进度追踪",
            "price": "$10",
            "originalPrice": "",
            "priceSuffix": "/月",
            "pricingModel": "订阅",
            "url": "https://www.getnextstep.io/",
            "category_en": "Project management",
            "is_ai": False,
            "source": "curated"
        },
        ...
        # ===== 邮件营销类 =====
        {
            "id": "CUR-100",
            "tag": "邮件营销",
            "title": "Kit（原 ConvertKit）",
            "slug": "convertkit",
            "desc": "创作者邮件营销平台；免费版最高支持 10,000 名订阅者，付费方案随订阅者规模调整",
            "price": "$0",
            "originalPrice": "",
            "priceSuffix": "/月起",
            "pricingModel": "订阅",
        ...
        # ===== 个人效率/生活类 =====
        {
            "id": "CUR-120",
            "tag": "效率工具",
            "title": "LiveIt（原 Journal it!）",
            "slug": "journal-it",
            "desc": "日记、规划、笔记、习惯与目标管理一体化，支持离线使用和可选端到端加密",
            "price": "$99",
            "originalPrice": "",
            "priceSuffix": "/终身",
            "pricingModel": "终身",
